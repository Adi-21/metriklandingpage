...
export function ExpandableNav({
  ...
  return (
    <div
      ref={outsideClickRef}
      className={cn(
        "flex flex-wrap items-center gap-2 rounded-2xl border bg-white/70 p-3 shadow-sm backdrop-blur-md",
        className
      )}
    >
      {tabs.map((tab, index) => {
        ...
        return (
          <motion.button
            ...
            className={cn(
              "relative flex items-center rounded-xl py-3 text-lg font-medium transition-colors duration-300",
              selected === index
