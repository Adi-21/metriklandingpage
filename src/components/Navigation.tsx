...
export const Navigation = () => {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[95%] max-w-7xl">
      <div className="relative rounded-3xl border bg-white/70 p-5 shadow-xl backdrop-blur-md">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-5">
            <img
              ...
              className="w-14 h-14"
            />
            <span className="text-4xl font-bold font-space bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent">
              METRIK
            </span>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="h-[36px] w-[1.2px] bg-gray-200" />
            <Button
              variant="outline"
              onClick={() => {
            ...
            {/* <Button 
              className="font-inter font-semibold rounded-2xl text-lg px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-500 text-white"
            >
              Start Earning
            </Button> */}
          </div>
              ...
              <div className="flex flex-col space-y-4 p-4">
                ...
                <div className="border-t pt-4 flex flex-col space-y-3">
                  <Button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-blue-500 text-white font-inter font-medium rounded-xl w-full"
                  >
                    Launch App
                  </Button>
